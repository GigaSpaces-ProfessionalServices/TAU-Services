...
public class GetInternalIdServerConfig {
    ...
    ServerMapping server() {
        return new GetInternalIdServerMapping(minPort, maxPort, serviceId, requiredRole, consulHost, consulPort, healthReporter, version, requestHandler, serviceCatalog);
    }
