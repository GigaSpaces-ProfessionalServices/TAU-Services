...
public class Person_Tziun_KursServerConfig {
    ...
    ServerMapping server() {
        return new Person_Tziun_KursServerMapping(minPort, maxPort, serviceId, requiredRole, consulHost, consulPort, healthReporter, version, requestHandler, serviceCatalog);
    }
