...
public class Person_ScheduleServerConfig {
    ...
    ServerMapping server() {
        return new Person_ScheduleServerMapping(minPort, maxPort, serviceId, requiredRole, consulHost, consulPort, healthReporter, version, requestHandler, serviceCatalog);
    }
