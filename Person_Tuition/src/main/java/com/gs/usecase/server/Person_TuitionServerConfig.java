...
public class Person_TuitionServerConfig {
    ...
    ServerMapping server() {
        return new Person_TuitionServerMapping(minPort, maxPort, serviceId, requiredRole, consulHost, consulPort, healthReporter, version, requestHandler, serviceCatalog);
    }
