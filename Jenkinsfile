pipeline {
    ...
    parameters {
        choice (
            choices: ['Create a new service', 'Deploy an existing service', 'Create and deploy a new service'], 
            description: 'Choose a preferred action', 
            name: 'ACTION'
            )
            ...
            input {
                ...
                parameters {
                    string description: 'The name of the new service', name: 'SERVICE_NAME', trim: true
                }
            }

        choice (
            choices: ['Development', 'Stage', 'Production'], 
            description: '* for deployment Choose the preferred environment', 
            name: 'ENVIRONMENT'
            )
