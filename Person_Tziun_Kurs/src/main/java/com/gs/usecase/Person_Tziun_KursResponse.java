...
public class Person_Tziun_KursResponse implements ServiceResponse {
    ...
    public Person_Tziun_KursResponse(ResultSet rs) throws SQLException {
        ...
        setTL_KURS_K_PNIMI(rs.getBigDecimal("TL_KURS_K_PNIMI"));
        setTA_PERSON_IDNO(rs.getString("TA_PERSON_IDNO"));
        setTA_PERSON_SHEM_MISHP(rs.getString("TA_PERSON_SHEM_MISHP"));
        setTA_PERSON_SHEM_PRATI(rs.getString("TA_PERSON_SHEM_PRATI"));
        setTA_PERSON_SHEM_MISHP_ENG(rs.getString("TA_PERSON_SHEM_MISHP_ENG"));
        setTA_PERSON_SHEM_PRATI_ENG(rs.getString("TA_PERSON_SHEM_PRATI_ENG"));
        setTL_TOCHNIT_CHUG(rs.getString("TL_TOCHNIT_CHUG"));
        setTL_TOCHNIT_OFEN_LIMUD(rs.getString("TL_TOCHNIT_OFEN_LIMUD"));
        setTL_TOCHNIT_MASLUL(rs.getString("TL_TOCHNIT_MASLUL"));
        setTL_KURS_K_SEM(rs.getString("TL_KURS_K_SEM"));
        setTL_KURS_K_KURS(rs.getString("TL_KURS_K_KURS"));
        setTL_KURS_KVUTZA(rs.getString("TL_KURS_KVUTZA"));
        setTL_KURS_MISGERET(rs.getString("TL_KURS_MISGERET"));
        setTL_KURS_TZIUN_SOFI(rs.getBigDecimal("URS_TZIUN_SOFI"));
        setTL_KURS_SEM_KVUTZA(rs.getString("TL_KURS_SEM_KVUTZA"));
        setTL_KURS_KOD_TZIUN(rs.getString("TL_KURS_KOD_TZIUN"));
        setTL_KURS_MOED_KOVEA(rs.getString("TL_KURS_MOED_KOVEA"));
        setTL_KURS_MATZAV_TZIUN(rs.getString("TL_KURS_MATZAV_TZIUN"));
        setTL_KURS_PTOR(rs.getString("TL_KURS_PTOR"));
        setTL_KURS_LSHKLL(rs.getString("TL_KURS_LSHKLL"));
        setTL_KURS_HUSHLAM(rs.getString("TL_KURS_HUSHLAM"));
        setTL_KURS_CHOZER(rs.getString("TL_KURS_CHOZER"));
        setTL_KURS_KOVEA(rs.getString("TL_KURS_KOVEA"));
        setTL_KURS_SHAOT_UNI(rs.getBigDecimal("TL_KURS_SHAOT_UNI"));
        setTL_KURS_MISHKAL(rs.getBigDecimal("TL_KURS_MISHKAL"));
        setTL_KURS_SHAOT_SCL(rs.getBigDecimal("TL_KURS_SHAOT_SCL"));
        setKR_KURS_TEUR_K(rs.getString("KR_KURS_TEUR_K"));
        setKR_KURS_TEUR_ENG_K(rs.getString("KR_KURS_TEUR_ENG_K"));
        setKR_KURS_TEUR_KURS(rs.getString("KR_KURS_TEUR_KURS"));
        setKR_KURS_TEUR_ENG(rs.getString("KR_KURS_TEUR_ENG"));
        setKR_KURS_SHAOT_UNI(rs.getBigDecimal("KR_KURS_SHAOT_UNI"));
        setKR_KURS_MISHKAL(rs.getBigDecimal("KR_KURS_MISHKAL"));
        setKR_KURS_LSHKLL(rs.getString("KR_KURS_LSHKLL"));
        setKR_KURS_LSHKLL(rs.getString("KR_KURS_LSHKLL"));
        setKR_KURS_OFEN_HORAA1(rs.getString("KR_KURS_OFEN_HORAA1"));
        setTB_002_OFEN_HORAA_TEUR_K1(rs.getString("TB_002_OFEN_HORAA_TEUR_K1"));
        setTB_002_OFEN_HORAA_TEUR_ENG_K1(rs.getString("TB_002_OFEN_HORAA_TEUR_ENG_K1"));
        setTB_071_SIMUL_TZIUN_TEUR(rs.getString("TB_071_SIMUL_TZIUN_TEUR"));
        setTB_071_SIMUL_TZIUN_TEUR_ENG(rs.getString("TB_071_SIMUL_TZIUN_TEUR_ENG"));
        setTB_036_MATZAV_TZIUN_TEUR(rs.getString("TB_036_MATZAV_TZIUN_TEUR"));
    }
